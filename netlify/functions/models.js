const MODELS = [
  ...
  { id: 'deepseek/deepseek-r1',                  label: 'DeepSeek R1 (reasoning)',price_in: 0.55,  price_out: 2.19 },
...
exports.handler = async () => ({ statusCode: 200, headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(MODELS) });
